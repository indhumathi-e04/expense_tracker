...
class Diamensions {
  ...
  static double height60 = screenHeight / 13.7;
  static double height70 = screenHeight / 11.8;
  ...
  static double radius12 = screenHeight / 68.8;
  static double radius25 = screenHeight / 33;
